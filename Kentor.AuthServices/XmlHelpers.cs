...
namespace Kentor.AuthServices
{
    ...
    public static class XmlHelpers
    {
        ...
        ///     XmlDocument to be signed. The signature is
        ///     added as a node in the document, right after the Issuer node.
        /// </param>
        ...
        ///     xmlElement to be signed. The signature is
        ///     added as a node in the document, right after the Issuer node.
        /// </param>
        /// <param name="cert">Certificate to use when signing.</param>
        /// <param name="includeKeyInfo">Include public key in signed output.</param>
        ...
        ///     If the data has
        ///     been tampered with or is not valid according to the SAML spec.
        /// </exception>
            ...
            bool validateCertificate)
        {
            ...
            catch (CryptographicException)
            {
                if (signedXml.SignatureMethod == Options.RsaSha256Namespace &&
                    CryptoConfig.CreateFromName(signedXml.SignatureMethod) == null)
                {
                    throw new InvalidSignatureException(
                        "SHA256 signatures require the algorithm to be registered at the process level. Call Kentor.AuthServices.Configuration.Options.GlobalEnableSha256XmlSignatures() on startup to register.");
                }
                throw;
            }
        }
        ...
        [SuppressMessage("Microsoft.Naming", "CA2204:Literals should be spelled correctly",
            MessageId = "ValidateCertificates")]
        ...
        private static void FixSignatureIndex(SignedXml signedXml, XmlElement signatureElement)
        {
            ...
            if (signaturePosition != null)
            {
                ...
                var correctSignaturePosition = 0;
                for (var i = 0; i < signaturesInParent.Count; i++)
                {
        ...
        private static readonly string[] allowedTransforms =
        {
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope",
            Justification = "I don't care, the StringWriter contains no references to unmanaged resources")]
